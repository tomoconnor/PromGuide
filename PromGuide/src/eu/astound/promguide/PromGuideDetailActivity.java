...
public class PromGuideDetailActivity extends Activity{
	...
	public void onCreate(Bundle bundle) {
        ...
        final Prom thisProm = promList.get(promID.intValue());
        ...
        promDescription.setText(Html.fromHtml(thisProm.getDescription()));
        ...
        promWebLink.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
        		...
        		Intent i = new Intent(v.getContext(),PromBrowserActivity.class);
        		i.putExtra("eu.astound.promguide.PromBrowserActivity.PROM_URL", thisProm.getDataURL());
